...
async def start(message: types.Message):
    ...
    '🆘\nСправка: /help\nНовости, информация о проекте, гослосования о новых функцих: https://t.me/eduverse_official', parse_mode='HTML', reply_markup=keyboards.main()
    )
...
async def schedule(message: types.Message):
    ...
    if datetime.date.today().isoweekday() == 1 or datetime.date.today().isoweekday() == 6:
        await message.answer("1. 8.00-8.40\n2. 8.45-9.25\n3. 9.35-10.15\n4. 10.30-11.10\n5. 11.25-12.05\n6. 12.20-13.00\n7. 13.10-13.50", reply_markup=keyboards.main())
